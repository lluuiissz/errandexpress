...
urlpatterns = [
    ...
    # Intercept standard Django admin auth pages
    path('admin/database/login/', RedirectView.as_view(pattern_name='admin_login', permanent=False, query_string=True)),
    path('admin/database/logout/', views.logout_view, name='admin_logout'),
    ...
    # Admin Login (Separate, dedicated)
