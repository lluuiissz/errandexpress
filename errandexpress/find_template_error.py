...
if errors:
    ...
    print("✅ No errors found! All tags are balanced.")

# Show context around line 315
print("\nContext around line 315:")
for i in range(max(0, 314-10), min(len(lines), 314+10)):
    marker = ">>> " if i == 314 else "    "
